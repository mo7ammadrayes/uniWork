...
public class GameWindow {
    ...
    /**
     * <p>startScoresMultP.</p>
     *
     * @param game a {@link uk.ac.soton.comp1206.game.Game} object
     * @param x a {@link javafx.beans.property.SimpleListProperty} object
     */
    public void startScoresMultP(Game game, SimpleListProperty<Pair<String,Integer>> x) {
        loadScene(new ScoreScene(this, game,x));
    }

    /**
     * <p>startLobby.</p>
     */
    public void startLobby(){   this.loadScene(new LobbyScene(this));
    }
/**
 * <p>startMultiplayer.</p>
 */
public void startMultiplayer(){this.loadScene(new MultiplayerScene(this));}
    /**
     ...
     */
    public void startIntro(){this.loadScene(new IntroScene(this));}
